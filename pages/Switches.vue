<template>
    <v-container>
        ...
        <v-col>
            ...
            <ModelAsArraySwitch id="ModelAsArraySwitch"  />
        </v-col>
        ...
        <v-col>
            ...
            <ModelAsBooleanSwitch id="ModelAsBooleanSwitch"  />
        </v-col>
