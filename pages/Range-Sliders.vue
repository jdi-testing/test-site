<template>
    <v-container>
        ...
        <v-col>
            ...
            <StepRangeSlider id="StepRangeSlider" />
        </v-col>

        <v-col>
            <p class="text-h5">
                Vertical sliders range slider
            </p>
            <VerticalSlidersRangeSlider id="VerticalSlidersRangeSlider" />
        </v-col>

        <v-col>
            <p class="text-h5">
                Thumb label range slider
            </p>
        ...
        <v-col>
            <p class="text-h5">
                Append And Prepend Icons With RangeSlider
            </p>
